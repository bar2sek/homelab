...
He creates workers using a Cloud-init doctl --user-data-file method that inputs the worker.yml file generated by talos at creation time. Same with Controlplane nodes.
